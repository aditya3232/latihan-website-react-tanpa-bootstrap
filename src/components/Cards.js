// komponen cards akan mengambil komponen Carditem (yang berisi list berupa data image, text, label, & path)
// komponen ini akan memanggil komponen Carditem secara berulang
// nanti komponen cards akan diambil oleh page Home
// ketika memanggil komponen secara berulang, jgn lupa harus dibungkus,
// Disini komponen <CardItem /> dibungkus oleh <ul></ul>
      ...
      <div className="cards__container">
        <div className="cards__wrapper">
          <ul className="cards__items">
            ...
            <CardItem src="images/img-2.jpg" text="Travel through the Islands of Bali in a Private with good deal" label="Luxury" path="/services" />
          </ul>
          <ul className="cards__items">
